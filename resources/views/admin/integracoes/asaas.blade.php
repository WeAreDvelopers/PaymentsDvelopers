    ...
    <div class="col-6">
        <div class="card">
            <form action="{{route('admin.integracoes.store')}}" id="formStore">
                ...
                <input type="hidden" name="endpoint_producao" value="https://api.asaas.com">
                <input type="hidden" name="endpoint_sandbox" value="https://sandbox.asaas.com/api">
                <input type="hidden" name="cliente_id" value="">
                <input type="hidden" name="token_public" value="">
                <div class="card-header border-bottom">
                    <div class="row justify-content-center">
                        <div class="col-6"><img src="{{asset('img/integracoes/asaas.png')}}" class="w-100" alt=""></div>
                    </div>
