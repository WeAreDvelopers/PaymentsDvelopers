<li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('admin.formas_pagamentos.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-money-check-alt"></i>
            </div>
            <span class="nav-link-text ms-1">Formas de Pagamento</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link  " href="{{route('admin.dca_taxas.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
