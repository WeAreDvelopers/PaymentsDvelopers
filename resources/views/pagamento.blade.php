...
<body>
   ...
   <div class="cardInfo  @if(!$carrinho->lead) d-none @endif ps-sm-5 pt-sm-3 p-3 xpto" id="cardInfo">
        ...
        <div class="row  mt-4">
            ...
            <div class="row align-items-end cupom">
                <div class="col-4">
                    ...
                    <input type="text" name="cupom" class="form-control" id="">
                </div>
                <div class="col-auto">
                    <button type="button" id="aplicarCupom" class="btn btn-primary m-0">Aplicar</button>
                </div>
            </div>
            @endif
    ...
    <div class="thaks-session mt-5 d-none" id="thanksPage">
        <div class="container">
            <div class="fundo-pagamento p-5 text-center" style="margin: 0 auto;">
                <h1 class="">Obrigado!</h1>
                <p class="" style="font-size: 25px;">Verifique seu email para acessar a Números Não Mentem.</p>
            </div>
